  ...
  const applyStyles = useCallback((rendition: Rendition) => {
    ...
    rendition.themes.default({
      body: {
        ...
        'max-width': `min(${readerSettings.maxWidth}px, calc(100% - ${readerSettings.marginHorizontal * 2}px))`,
        width: '100%',
  ...
  useEffect(() => {
    ...
    const initEpub = async () => {
      ...
      try {
        ...
        await epub.locations.generate(2048);
        ...
        if (book.currentLocation) {
          ...
          if (initialLocation) {
            handleLocationChange(initialLocation as unknown as Location);
          }
        }
